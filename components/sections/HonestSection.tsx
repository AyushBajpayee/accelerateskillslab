            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl text-white leading-tight">
                        <span className="font-bold">
                            Breaking into <span className="text-primary">data engineering careers</span> shouldn't feel this hard.
                        </span>
                        <br />
                        <span className="italic font-normal" style={{ fontFamily: '"IBM Plex Serif", "IBM Plex Serif Placeholder", serif', letterSpacing: '-0.02em' }}>Our bootcamp makes the impossible possible.</span>
                    </h2>
                </motion.div>
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        >
                            <h3 className="text-xl font-bold text-white mb-2">The reality check</h3>
                        ...
                        <motion.div
                            ...
                            className="relative bg-[#111827] rounded-2xl p-8 border border-blue-500/30"
                        >
                            {/* Subtle glow effect */}
                            <div className="absolute inset-0 rounded-2xl bg-linear-to-r from-blue-500/5 to-cyan-500/5 pointer-events-none" />
                            
                            <div className="relative">
                                <h3 className="text-xl font-bold text-white mb-2">The shortcut that works</h3>
                                <p className="text-sm text-gray-400 mb-6">
...
// background: linear-gradient(90deg,#4c31e200 0%,var(--token-23d5e5a9-1678-4fb2-b7a3-10b6c07f2e1e,#2756f7)50%,#4c31e200 100%);
//   opacity: .64;
//   z-index: 1;
//   flex: none;
//   width: 480px;
