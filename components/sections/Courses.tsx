...
const courses = [
    {
        ...
        description: "This redesigned curriculum condenses the complete data analytics journey into an intensive 3-month program suitable for full-time learners or highly committed part-time students. Master Excel, Python, SQL, Tableau, Power BI, and build portfolio projects that land interviews.",
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight">
                        ...
                        <br />
                        <span className="text-2xl sm:text-3xl lg:text-4xl font-normal">Our bootcamp takes you from Zero to Hero.</span>
                    </h3>
                </motion.div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-2 mb-4">
                                        <div className={`w-3 h-3 rounded-full ${course.categoryColor}`} />
                                        <span className={`text-sm font-medium ${course.categoryTextColor}`}>
                                            {course.category}
                                        </span>
                                    </div>
